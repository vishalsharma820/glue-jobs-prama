...
variable "script_local_path" {
  type        = string
  description = "The local file path to the Glue job script to upload to S3."
}

variable "script_key" {
  type        = string
  description = "The S3 key (object path) where the Glue job script will be uploaded."
}

variable "s3_bucket" {
  type        = string
  description = "The S3 bucket where the Glue job script will be uploaded."
}
